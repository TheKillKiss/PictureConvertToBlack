...
Q_IMPORT_QML_PLUGIN(PictureConvertPlugin)
Q_IMPORT_QML_PLUGIN(PictureConvertContentPlugin)

const char mainQmlFile[] = "qrc:/qt/qml/PictureConvertContent/App.qml";
